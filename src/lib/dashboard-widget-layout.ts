...
const baseExecutiveLayouts: DashboardGridLayouts = {
  lg: [
    ...
    { i: "bookings", x: 0, y: 8, w: 3, h: 4 },
    { i: "channels", x: 3, y: 8, w: 3, h: 4 },
  ...
  md: [
    ...
    { i: "bookings", x: 6, y: 8, w: 3, h: 4 },
    { i: "channels", x: 9, y: 8, w: 3, h: 4 },
    { i: "recent-bookings", x: 0, y: 12, w: 12, h: 5 },
  ],
  sm: [
    ...
    { i: "channels", x: 2, y: 18, w: 2, h: 4 },
    { i: "recent-bookings", x: 0, y: 22, w: 4, h: 5 },
  ],
};
...
const presetLayouts: Record<Exclude<DashboardWidgetPresetId, "custom">, DashboardGridLayouts> = {
  ...
  finance: {
    lg: [
      ...
      { i: "channels", x: 0, y: 8, w: 4, h: 4 },
      { i: "bookings", x: 4, y: 8, w: 2, h: 4 },
      { i: "recent-bookings", x: 6, y: 8, w: 6, h: 5 },
    ],
  ...
  operations: {
    lg: [
      { i: "recent-bookings", x: 0, y: 0, w: 7, h: 6 },
      { i: "bookings", x: 7, y: 0, w: 2, h: 4 },
      { i: "channels", x: 9, y: 0, w: 3, h: 4 },
      { i: "net-profit", x: 7, y: 4, w: 5, h: 5 },
      { i: "revenue-pulse", x: 0, y: 6, w: 4, h: 4 },
      { i: "revenue-vs-expenses", x: 4, y: 6, w: 4, h: 4 },
      { i: "expense-pressure", x: 8, y: 9, w: 4, h: 5 },
    ],
    md: baseExecutiveLayouts.md,
    sm: baseExecutiveLayouts.sm,
  },
