...
const baseExecutiveLayouts: DashboardGridLayouts = {
  lg: [
    ...
    { i: "bookings", x: 0, y: 7, w: 3, h: 3 },
    { i: "channels", x: 3, y: 7, w: 3, h: 3 },
    { i: "recent-bookings", x: 6, y: 7, w: 6, h: 4 },
  ],
  md: [
    ...
    { i: "bookings", x: 6, y: 8, w: 3, h: 3 },
    { i: "channels", x: 9, y: 8, w: 3, h: 3 },
    { i: "recent-bookings", x: 0, y: 12, w: 12, h: 4 },
  ],
  sm: [
    { i: "net-profit", x: 0, y: 0, w: 4, h: 5 },
    { i: "revenue-pulse", x: 0, y: 5, w: 4, h: 4 },
    { i: "expense-pressure", x: 0, y: 9, w: 4, h: 5 },
    { i: "revenue-vs-expenses", x: 0, y: 14, w: 4, h: 3 },
    { i: "bookings", x: 0, y: 17, w: 2, h: 3 },
    { i: "channels", x: 2, y: 17, w: 2, h: 3 },
    { i: "recent-bookings", x: 0, y: 20, w: 4, h: 5 },
  ],
};
...
const presetLayouts: Record<Exclude<DashboardWidgetPresetId, "custom">, DashboardGridLayouts> = {
  ...
  finance: {
    lg: [
      { i: "net-profit", x: 0, y: 0, w: 5, h: 7 },
      { i: "expense-pressure", x: 5, y: 0, w: 4, h: 7 },
      { i: "revenue-vs-expenses", x: 9, y: 0, w: 3, h: 4 },
      { i: "revenue-pulse", x: 9, y: 4, w: 3, h: 3 },
      { i: "channels", x: 0, y: 7, w: 4, h: 3 },
      { i: "bookings", x: 4, y: 7, w: 2, h: 3 },
      { i: "recent-bookings", x: 6, y: 7, w: 6, h: 4 },
    ],
  ...
  operations: {
    lg: [
      { i: "recent-bookings", x: 0, y: 0, w: 7, h: 5 },
      { i: "bookings", x: 7, y: 0, w: 2, h: 3 },
      { i: "channels", x: 9, y: 0, w: 3, h: 3 },
      { i: "net-profit", x: 7, y: 3, w: 5, h: 4 },
      { i: "revenue-pulse", x: 0, y: 5, w: 4, h: 4 },
      { i: "revenue-vs-expenses", x: 4, y: 5, w: 4, h: 4 },
      { i: "expense-pressure", x: 8, y: 7, w: 4, h: 6 },
    ],
    md: baseExecutiveLayouts.md,
    sm: baseExecutiveLayouts.sm,
  },
