...
const baseExecutiveLayouts: DashboardGridLayouts = {
  lg: [
    ...
    { i: "bookings", x: 0, y: 7, w: 4, h: 4 },
    { i: "channels", x: 4, y: 7, w: 4, h: 4 },
    { i: "recent-bookings", x: 0, y: 11, w: 8, h: 8 },
    { i: "recent-expenses", x: 8, y: 11, w: 4, h: 8 },
  ],
  md: [
    ...
    { i: "bookings", x: 0, y: 12, w: 6, h: 4 },
    { i: "channels", x: 6, y: 12, w: 6, h: 4 },
    { i: "recent-bookings", x: 0, y: 16, w: 12, h: 8 },
    { i: "recent-expenses", x: 0, y: 24, w: 12, h: 8 },
  ],
  sm: [
    ...
    { i: "channels", x: 0, y: 22, w: 4, h: 4 },
    { i: "recent-bookings", x: 0, y: 26, w: 4, h: 8 },
    { i: "recent-expenses", x: 0, y: 34, w: 4, h: 8 },
  ],
};
...
const presetLayouts: Record<Exclude<DashboardWidgetPresetId, "custom">, DashboardGridLayouts> = {
  ...
  finance: {
    lg: [
      ...
      { i: "channels", x: 0, y: 7, w: 4, h: 4 },
      { i: "bookings", x: 4, y: 7, w: 4, h: 4 },
      { i: "recent-bookings", x: 0, y: 11, w: 8, h: 8 },
      { i: "recent-expenses", x: 8, y: 11, w: 4, h: 8 },
    ],
  ...
  operations: {
    lg: [
      { i: "recent-bookings", x: 0, y: 0, w: 8, h: 8 },
      { i: "recent-expenses", x: 8, y: 0, w: 4, h: 8 },
      { i: "bookings", x: 0, y: 8, w: 4, h: 4 },
      { i: "channels", x: 4, y: 8, w: 4, h: 4 },
      { i: "net-profit", x: 8, y: 8, w: 4, h: 4 },
